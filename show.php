...
h1{
     ...
     function ajax(a, b, c) {
       ...
       xmlhttp.onreadystatechange = function () {
         if (this.readyState == 4 && this.status == 200) {
           document.getElementById('tal'+c).innerHTML = this.responseText;
         }
       }
       xmlhttp.open("GET", 'stars.php?count=' + a +'&svar=' + b, true);
       xmlhttp.send();
     }
    </script>
 ...
 <nav>
  <ul class="navbar">
  <li class="navpunkt"><a class="navlink" href="forside.php">Forside</a></li>
  <li class="navpunkt"><a class="navlink" href="index.php">Lav Sp&oslash;rgsm&aring;l</a></li>
<?php 
...
if($_GET['id']==$answer['id']){
    echo "<section class='answer grey'>";
    echo $answer['Forfatter']; 
    echo "<div class='centered' onclick='ajax(+1,";
    echo $answer['svar-id'];
    echo ",";
    echo $i;
    echo ")' >&#8679;</div>";
    ...
    echo $i;
    echo "'>";
    echo $answers[$answer['svar-id']]['upvotes'];
    echo "</p>";
    echo "<div class='centered' onclick='ajax(-1,";
    echo $answer['svar-id'];
    echo ",";
